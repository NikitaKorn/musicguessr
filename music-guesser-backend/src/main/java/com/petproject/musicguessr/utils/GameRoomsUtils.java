...
public final class GameRoomsUtils {
    public static <T extends AbstractSessionRoomHandler> Predicate<GameRoom<T>> isSoloGameRoom() {
        return room -> room.getType() == GameRoom.Type.SOLO;
    }

    public static <T extends AbstractSessionRoomHandler> Predicate<GameRoom<T>> isPartyGameRoom() {
        return room -> room.getType() == GameRoom.Type.PARTY;
    }
